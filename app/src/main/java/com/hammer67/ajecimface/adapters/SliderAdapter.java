...
public class SliderAdapter   extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        if (sliderItem.getImageUrl() != null){
            if (!sliderItem.getImageUrl().isEmpty()){
                Picasso.with(context).load(sliderItem.getImageUrl()).into(viewHolder.mImageViewSlider);
            }
        }
    ...
    class SliderAdapterVH extends SliderViewAdapter.ViewHolder {
        ...
        View itemView;
        ImageView mImageViewSlider;


        public SliderAdapterVH(View itemView) {
            super(itemView);
            mImageViewSlider = itemView.findViewById(R.id.imageViewSlider);
